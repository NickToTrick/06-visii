...
jQuery(window).scroll(function() {
    var wintop = $(window).scrollTop(), docheight = $('.body-wrapper').height(), winheight = $(window).height();
    // console.log(wintop);
...
function initSlickCarousel() {
    ...
    jQuery('.slick-slider-vertical').slick({
        slidesToScroll: 1,
        rows: 0,
        arrows: false,
        dots: true,
    ...
    jQuery('.itemslider').carousel({ interval: 30000 });
